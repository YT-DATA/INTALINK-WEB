    ...
    <el-form>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :label="3">
                周期从
                <el-select clearable v-model="cycle01" :teleported="false">
                    <el-option
                ...
                -
                <el-select clearable v-model="cycle02" :teleported="false">
                    <el-option
                        v-for="(item,index) of weekList"
                        :key="index"
                        :label="item.value"
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :label="4">
                ...
                <el-select clearable v-model="average02" :teleported="false">
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :label="5">
                本月最后一个
                <el-select clearable v-model="weekday" :teleported="false">
                    <el-option v-for="item in weekList" :key="item.key" :label="item.value" :value="item.key" />
                </el-select>
            </el-radio>
        </el-form-item>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :label="6">
                指定
                <el-select class="multiselect" clearable v-model="checkboxList" placeholder="可多选" multiple :multiple-limit="6" :teleported="false">
                    <el-option v-for="item in weekList" :key="item.key" :label="item.value" :value="item.key" />
                </el-select>
            </el-radio>
        </el-form-item>
